...
import com.eap.framework.base.pojo.FieldSetting;
import com.eap.framework.base.pojo.GenerateSetting;
...
import com.eap.framework.utils.FreeMarkerUtil;
...
public class CodeGeneratorController {
    ...
    public Result getXMLContent(String queryId, String className, String modelName) throws ClassNotFoundException {
        ...
        for (Field field : fields) {
            ...
            String classType=field.getType().getName().startsWith("com.eap")?String.class.getSimpleName():field.getType().getSimpleName();

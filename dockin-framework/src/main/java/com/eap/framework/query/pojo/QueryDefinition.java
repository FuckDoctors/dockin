...
import com.eap.framework.query.entity.QueryContext;
import com.eap.framework.utils.ConfigurationUtil;
            ...
            for (int i = 0; i < resources.length; i++) {
                ...
                try {
                    QueryContext queryContext = (QueryContext) ConfigurationUtil.parseXMLObject(
                            com.eap.framework.query.entity.QueryContext.class, resource);

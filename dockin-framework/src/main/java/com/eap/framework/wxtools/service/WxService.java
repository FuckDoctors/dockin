package com.eap.framework.wxtools.service;
...
import com.eap.framework.wxtools.bean.result.WxBatchGetMaterialResult;
import com.eap.framework.wxtools.bean.result.WxMenuResult;
import com.eap.framework.wxtools.bean.result.WxVideoMediaResult;
import com.eap.framework.wxtools.bean.InvokePay;
import com.eap.framework.wxtools.bean.PayOrderInfo;
import com.eap.framework.wxtools.bean.PreviewSender;
import com.eap.framework.wxtools.bean.TemplateSender;
import com.eap.framework.wxtools.bean.WxGroupSender;
import com.eap.framework.wxtools.bean.WxJsapiConfig;
import com.eap.framework.wxtools.bean.WxMenu;
import com.eap.framework.wxtools.bean.WxNewsInfo;
import com.eap.framework.wxtools.bean.WxOpenidSender;
import com.eap.framework.wxtools.bean.WxQrcode;
import com.eap.framework.wxtools.bean.WxUserList;
import com.eap.framework.wxtools.bean.WxUserList.WxUser;
import com.eap.framework.wxtools.bean.WxUserList.WxUser.WxUserGet;
import com.eap.framework.wxtools.bean.WxVideoIntroduction;
import com.eap.framework.wxtools.bean.result.IndustryResult;
import com.eap.framework.wxtools.bean.result.QrCodeResult;
import com.eap.framework.wxtools.bean.result.SenderResult;
import com.eap.framework.wxtools.bean.result.TemplateListResult;
import com.eap.framework.wxtools.bean.result.TemplateResult;
import com.eap.framework.wxtools.bean.result.TemplateSenderResult;
import com.eap.framework.wxtools.bean.result.WxCurMenuInfoResult;
import com.eap.framework.wxtools.bean.result.WxError;
import com.eap.framework.wxtools.bean.result.WxMaterialCountResult;
import com.eap.framework.wxtools.bean.result.WxMediaUploadResult;
import com.eap.framework.wxtools.bean.result.WxNewsMediaResult;
import com.eap.framework.wxtools.bean.result.WxOAuth2AccessTokenResult;
import com.eap.framework.wxtools.bean.result.WxUserGroupResult;
import com.eap.framework.wxtools.bean.result.WxUserListResult;
import com.eap.framework.wxtools.exception.WxErrorException;
import com.eap.framework.wxtools.util.http.RequestExecutor;
